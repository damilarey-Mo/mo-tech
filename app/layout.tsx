...
export const metadata: Metadata = {
  ...
  description: "TeaMo provides comprehensive IT support, web development, and tech solutions for businesses in Lagos, Nigeria. Trust in our family-run tech company for expert service.",
